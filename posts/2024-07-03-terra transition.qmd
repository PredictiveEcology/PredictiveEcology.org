...
+----------------------------------+----------------------------------+
| `ras[]`                          | `as.vector(ras[])` or            |
|                                  | `as.vector(values(ras))`         |
+----------------------------------+----------------------------------+
| `compareCRS`                     | For now,\                        |
...
|                                  | `LandR::.compareCRS`             |
+----------------------------------+----------------------------------+
| `getValues`                      | `SpatRaster[]` returns a matrix, |
|                                  | even if it is just one layer;    |
|                                  | `RasterLayer[]` returns a        |
|                                  | vector; `RasterStack[]` returns  |
|                                  | a matrix\                        |
|                                  | \                                |
|                                  | For consistency, use:\           |
...
|                                  | `ra s[] <- as.integer            |
|                                  | (ras[])ras <- LandR::asInt(ras)` |
|                                  | works on `RasterLayer` or        |
|                                  | `SpatRaster`                     |
|                                  |                                  |
|                                  | `LandR::isInt` \# the equivalent |
|                                  | for `is.integer`\                |
|                                  | \                                |
+----------------------------------+----------------------------------+
...
|                                  | `SpaDES.core::Plot               |
|                                  | s(ras, fn = LandR::plotRast, …)` |
|                                  | available in `LandR@development` |
+----------------------------------+----------------------------------+
| `quickPlot::Plot(ras)`           | `quickPlot::Plot(ras)` – accepts |
|                                  | `SpatRaster`                     |
+----------------------------------+----------------------------------+
...
|                                  | does not accept a matrix for     |
|                                  | `cell` (unlike                   |
|                                  | `raster::xyFromCell`). But       |
...
|                                  | works on either `RasterLayer` or |
|                                  | `SpatRaster`                     |
+----------------------------------+----------------------------------+
