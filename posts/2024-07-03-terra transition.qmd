...
|                                  | `SpatRaster`                     |
+----------------------------------+----------------------------------+
| `as.integer(ras)` doesn’t work   | `ras <- LandR::asInt(ras)` works |
| for `SpatRaster` … this also     | on `RasterLayer` or `SpatRaster` |
| doesn’t work:\                   |                                  |
| `ras[] <- as.integer(ras[])`     | `LandR::isInt` \# the equivalent |
|                                  | for `is.integer`\                |
|                                  | \                                |
+----------------------------------+----------------------------------+
