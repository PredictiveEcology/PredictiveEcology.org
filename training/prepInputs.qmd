...
```{r}
SK <- SpaDES.project::setupStudyArea(list(level = 2, NAME_1 = "Saskatchewan", NAME_2 = "Division No. 1$"))
...
```{r}
SK <- SpaDES.project::setupStudyArea(list(level = 2, NAME_1 = "Saskatchewan", NAME_2 = "Division No. 1$", epsg = 5070))
